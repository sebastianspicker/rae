...
description: "Cursor adapter for post-build checks. Runs cleanup plus frontend/backend/docs/security audits and aggregates outcomes into a gate result."
---

# Post-Build - Cleanup and Audit Pass (Cursor Adapter)
