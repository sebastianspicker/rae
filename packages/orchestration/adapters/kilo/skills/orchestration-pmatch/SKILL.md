...
description: "Kilo adapter for /pmatch. Runs dual independent claim extraction and adjudicates drift before allowing progression."
---

# /pmatch - Dual-Extractor Drift Adjudication (Kilo Adapter)
