...
description: "Claude adapter for /design. Produces a first-principles design document from a validated brief with evidence-backed research and repository alignment."
---

# /design - Constraint-Grounded Design (Claude Adapter)
