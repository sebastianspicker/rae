...
description: "Claude adapter for /quality-static. Enforces lint, format-check, and type-check as a hard quality gate before tests and post-build audits."
---

# /quality-static - Static Quality Gate (Claude Adapter)
