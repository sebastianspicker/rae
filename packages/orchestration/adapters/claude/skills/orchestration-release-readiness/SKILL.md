...
description: "Claude adapter for /release-readiness. Verifies changelog, semver impact, migration readiness, rollback plan, and final approvals before ship."
---

# /release-readiness - Final Ship Gate (Claude Adapter)
