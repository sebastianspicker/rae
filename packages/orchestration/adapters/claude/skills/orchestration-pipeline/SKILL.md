...
description: "Claude adapter orchestrator for the full phased workflow. Advances stages only on passing gates and explicit human checkpoints."
---

# Orchestration Pipeline (Claude Adapter)
