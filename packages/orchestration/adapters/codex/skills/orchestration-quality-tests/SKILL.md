...
description: "Codex adapter for /quality-tests. Runs predeclared test commands as a dedicated gate before post-build audits."
---

# /quality-tests - Test Quality Gate (Codex Adapter)
