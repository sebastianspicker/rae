...
description: "Codex adapter for /plan. Converts approved design+review artifacts into implementation-ready, conflict-free task groups with explicit verification."
---

# /plan - Deterministic Execution Plan (Codex Adapter)
