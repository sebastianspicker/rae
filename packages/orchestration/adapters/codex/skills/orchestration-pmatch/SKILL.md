...
description: "Codex adapter for /pmatch. Runs dual independent claim extraction and adjudicates drift before allowing progression."
---

# /pmatch - Dual-Extractor Drift Adjudication (Codex Adapter)
