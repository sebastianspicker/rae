...
description: "Codex adapter for /ar. Runs independent specialist reviews in parallel, consolidates findings, and emits a fact-check-ready review report."
---

# /ar - Parallel Design Challenge (Codex Adapter)
