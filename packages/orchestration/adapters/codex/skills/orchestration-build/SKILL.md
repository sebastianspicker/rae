...
description: "Codex adapter for /build. Coordinates parallel builder subagents under strict context scoping and verifies plan conformance after implementation."
---

# /build - Coordinated Parallel Implementation (Codex Adapter)
