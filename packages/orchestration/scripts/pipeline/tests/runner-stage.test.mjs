...
describe("run-stage input validation", () => {
...
describe("run-stage arm phase success", () => {
...
describe("run-stage arm phase failure", () => {
...
describe("run-stage design phase", () => {
...
describe("run-stage state locking", () => {
...
describe("run-stage build task-session boundary", () => {
...
describe("run-stage quality-case session boundary", () => {
...
describe("run-stage release-readiness integration", () => {
