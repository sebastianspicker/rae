...
function validateOptionalReferences(input: Input): void {
...
function validateEventSource(input: Input): void {
...
export function validateInput(input: Input): void {
  ...
  validateOptionalReferences(input);
  validateEventSource(input);
}
