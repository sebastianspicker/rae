#!/usr/bin/env bash
# Regression coverage for Ralph's validation contract.
...
run_case "invalid-acceptance-type" '(.stories[0].acceptance_criteria) = ["Created .claude/ralph-audit/audit/x.md", 7]' "false"
