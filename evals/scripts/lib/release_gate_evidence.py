"""Evidence and artifact validation for release-gated benchmark runs."""

import json
import pathlib
from typing import Any, cast

from common import RESULTS_ROOT, load_json, load_json_object, resolve_metadata_path
...
# Artifact parsing may fail because a run produced unreadable or malformed
# evidence. Preserve those gate failures while allowing implementation bugs
# to surface instead of being misreported as missing evidence.
_ARTIFACT_READ_ERRORS = (OSError, UnicodeDecodeError, ValueError)
